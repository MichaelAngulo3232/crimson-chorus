...
1. Copy Crimson.vst3 into:
   ...
   You may need administrator permission to write to these folders.
...
--------------------------------
Crimson is not yet code-signed, so Windows reports it as coming
from an unknown publisher. Choose "More info" then "Run anyway".

If you would rather not, the full source is public and you can
build it yourself — link at the bottom.
